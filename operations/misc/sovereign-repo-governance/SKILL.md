---
name: "sovereign-repo-governance"
description: "(opencode - Skill) The March 2026 gold standard for autonomous repository manage"
version: "1.0.0"
author: "OpenSIN-AI"
category: "misc"
...
## 🚨 MANDATORY COUPLING: /visual-repo

**ABSOLUTE PFLICHT:** Wenn `/sovereign-repo-governance` ausgeführt wird, MUSS der Agent AUTOMATISCH auch `/visual-repo` ausführen!

**Begründung:** Ein Repo mit Governance aber ohne visuelle Dokumentation ist wie ein Auto mit Motor aber ohne Karosserie - technisch perfekt, aber niemand versteht es auf den ersten Blick.

**Reihenfolge:**
```
1. sovereign-repo-governance → Struktur, Issues, Governance, Wiki
2. visual-repo → Mermaid-Diagramme, Infografiken, README-Optimierung, 3-Sekunden-Hook
```
...
**NACH Abschluss von Part 1-3 MUSS der Agent den `/visual-repo` Skill ausführen!**

### Was /visual-repo macht:
1. **Developer-Diagramme:** Mermaid Architecture, Flow, Deployment Diagrams
2. **Nutzer-Infografiken:** Benefit Cards, Before/After, 3-Schritte-Grafik
3. **Psychologische Optimierung:** 3-Sekunden-Hook, WIIFM, Schmerz→Nutzen→Einfachheit
4. **README-Restrukturierung:** Goldene README-Struktur für maximale Verständlichkeit

### Ausführungsreihenfolge:
```
sovereign-repo-governance完成 → skill(name="visual-repo") → README + docs/architecture.md erstellen → Commit & Push
```
