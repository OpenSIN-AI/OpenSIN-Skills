---
name: "self-healer"
description: "Dieser Skill wird automatisch vom macOS Background Watcher ausgelöst, wenn ein S"
version: "1.0.0"
author: "OpenSIN-AI"
category: "misc"
...
4. **Reparieren**: Überschreibe die fehlerhafte Mikro-Datei (`step_XX.py`). 
   ...
   - Regel 2: Kommentiere ALLES ausführlich! Jede Funktion, jeder Schritt muss kommentiert werden. Kommentare sind ENORM WICHTIG!
