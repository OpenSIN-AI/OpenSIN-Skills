...
- For YouTube visual judging, configure Google auth via `--google-service-account-json` (RECOMMENDED) or Antigravity OAuth. Direct `GOOGLE_API_KEY` is PROHIBITED per OpenSIN mandate.
